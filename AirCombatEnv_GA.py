...
class F16Environment(gym.Env):
    ...
    def __init__(self):
        ...
        self.aircraft1 = Aircraft(0, 0, 1000, 100, 0, 0,constant_speed=True)
        self.aircraft2 = Aircraft(0, 1000, 1000, 100, np.pi, 0, constant_speed=True)
    ...
    def reset(self, heading1, heading2):
        """
        Reset the environment to the initial state.
        """
        self.aircraft1 = Aircraft(0, 0, 1000, 100, heading1, 0, constant_speed=True)
        self.aircraft2 = Aircraft(0, 1000, 1000, 100, heading2, 0, constant_speed=True)
